...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.row==0) {
        cell.firstLab.text=[NSString stringWithFormat:@"设备编号：%@",_XmlArray[@"DID"]];
        cell.secondLab.text=[NSString stringWithFormat:@"设备名称: %@",_XmlArray[@"PNAME"]];
        
        cell.ThirdLab.text=[NSString stringWithFormat:@"出厂日期： %@",[CommonTool daFormatByComment:_XmlArray[@"FACTROYDATE"]]];
        cell.fourLab.text=[NSString stringWithFormat:@"当前位置：%@",_XmlArray[@"USEPLACE"]];
        return cell;
        ...
        cell.firstLab.text=[NSString stringWithFormat:@"客户：%@",_XmlArray[@"CNAME"]];
        cell.secondLab.text=[NSString stringWithFormat:@"电话：%@",_XmlArray[@"PHONE"]];
        cell.ThirdLab.text=[NSString stringWithFormat:@"传真： %@",_XmlArray[@"FAX"]];
        cell.fourLab.text=[NSString stringWithFormat:@"邮编: %@",_XmlArray[@"ZIPCODE"]];
        cell.fiveLab.text=[NSString stringWithFormat:@"地址：%@",_XmlArray[@"ADDR"]];
        cell.sixLab.text=[NSString stringWithFormat:@"现场联系人：%@",_XmlArray[@"LINKER"]];
        cell.sevenLab.text=[NSString stringWithFormat:@"联系电话：%@",_XmlArray[@"LINKPHONE"]];
       
        cell.aintinLab.text=[NSString stringWithFormat:@"售出日期：%@", [CommonTool daFormatByComment:_XmlArray[@"SALETIME"]]];
        cell.nineLab.text=[NSString stringWithFormat:@"销售人员：%@",_XmlArray[@"PERSONNAME"]];
        return cell;
