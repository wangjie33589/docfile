...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    cell.accessoryType=UITableViewCellAccessoryDisclosureIndicator;
        ...
        cell.firstLab.text=[NSString stringWithFormat:@"工地名称:%@",[CommonTool handleEmptyString:_XmlArray[indexPath.row][@"CPNAME"]]];
  
    cell.secondLab.text=[NSString stringWithFormat:@"工地地址:%@",  [CommonTool handleEmptyString:_XmlArray[indexPath.row][@"CPADDR"]]];
    
    
    cell.ThirdLab.text=[NSString stringWithFormat:@"维护人员:%@",[CommonTool handleEmptyString:_XmlArray[indexPath.row][@"RPNAME"]]];
    NSLog(@"dfhghjfshjkjdgkljlkjfgkl;dafkshkgh=====%@",[CommonTool handleEmptyString:_XmlArray[indexPath.row][@"RPNAME"]]);
   
    cell.fourLab.text=[NSString stringWithFormat:@"联系电话:%@", [CommonTool handleEmptyString:_XmlArray[indexPath.row][@"PHONE"]]];
