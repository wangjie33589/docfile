...
- (void)viewDidLoad {
    ...
    UILabel *tobLab =[[UILabel alloc]initWithFrame:CGRectMake(0, 10, LWIDTH-10, 30)];
    tobLab.backgroundColor=[UIColor clearColor];
    tobLab.text=@"南京科远驱动技术有限公司         ";
    tobLab.font=[UIFont systemFontOfSize:12];
    tobLab.textColor=[UIColor whiteColor];

    
    tobLab.textAlignment=UITextAlignmentRight;
    [self.view addSubview:tobLab];
    [self.view addSubview:tobLab];
    
    UILabel *lab =[[UILabel alloc]initWithFrame:CGRectMake(0, 130, LWIDTH, 40)];
