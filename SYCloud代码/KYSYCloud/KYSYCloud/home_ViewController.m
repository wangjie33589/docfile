...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [self.navigationController pushViewController:vc animated:YES];
        ...
        repaireViewController *vc =[[repaireViewController alloc]initWithADic:_XmlArray[indexPath.row]];
        [self.navigationController pushViewController:vc animated:YES];
...
//        CheckController *vc =[[CheckController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//    
...
//        regist_Two_ViewController *vc =[[regist_Two_ViewController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//    }
//    else if (indexPath.row==7){
//        reportQuiryViewController *vc =[[reportQuiryViewController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//        
//        
//    }else if(indexPath.row==8){
//        repaireViewController *vc =[[repaireViewController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//    
//    
//    
//    }else if (indexPath.row==9){
//        repaireConfirmViewController *vc =[[repaireConfirmViewController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//    
//    
//    }else if (indexPath.row==10){
//        analyseViewController *vc =[[analyseViewController alloc]init];
//        [self.navigationController pushViewController:vc animated:YES];
//        
//        
//    
        ...
        if ((NSObject*)dictt[@"ERROR"]==[NSNull null] ) {
            ...
            for (int i =0; i<_XmlArray.count; i++) {
                ...
                [dict setObject:obj forKey:string];
                        ...
                        //[self requestBudgeNumberwithMcode:[self returnMcode:@"AlarmView" withdict:dict]];
            //[self requestBudgeNumberwithMcode:[self returnMcode:@"WRcdView" withdict:dict]];
...
-(void)requestBudgeNumberwithMcode:(NSString*)mcode withAction:(NSString*)action{
    ...
    manger.backSuccess=^void(NSDictionary *dictt){
        ...
        if ((NSObject*)dictt[@"ERROR"]==[NSNull null] ) {
            ...
            NSLog(@"skdfhsd====%d=====%d====%d",BJTXNuumber,BXDJNumber,WBQRNumber);
           NSInteger bgnumber =BJTXNuumber+BXDJNumber+WBQRNumber;
            
            [[UIApplication sharedApplication]setApplicationIconBadgeNumber:bgnumber];
